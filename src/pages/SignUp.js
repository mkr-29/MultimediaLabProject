...
import {
  containerrightvariants,
  containerleftvariants,
          ...
          <Row className="darkbg">
                  ...
                  <Form className="darkbg" onSubmit={handleSubmit}>
                    ...
                    <CardBody className="darkbg">
                      <h1 className="text-white text-left">
                        Create your account for tasty Indian Food.
                      </h1>
                      ...
                      <FormGroup>
                        <button
                          type="submit"
                          block
                          className="p-2 rounded-0 secondaryTextColor loginbtn mt-3"
                        >
                          Sign Up
                        </button>
                      </FormGroup>
                      <FormGroup>
                        ...
                        <button
                          ...
                          type="submit"
                          block
                          className="p-2 rounded-0  secondaryTextColor loginbtn"
                        >
                      ...
                      <FormGroup>
                        <p className="text-white text-center">
                          ...
                          <Link className="ml-2 linkhover" to="/signin">
                            Signin
                          </Link>
                        </p>
                      </FormGroup>
            ...
            <Col lg={6} className="mt-4">
              <motion.div
                ...
                animate="visible"
              >
                <img className="img-fluid mt-5" src={thalipic} alt="img" />
              </motion.div>
            </Col>
          </Row>
        </Container>
